      ...
      body: loading
          ...
          : SingleChildScrollView(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    Icon(Icons.person_add_alt, size: 60, color: theme.colorScheme.primary),
                    SizedBox(height: 10),
                    Text("User Information", style: theme.textTheme.headlineLarge),
                    SizedBox(height: 30),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(labelText: "Other Benefit (Optional)"),
                    ),
                    SizedBox(height: 24),
